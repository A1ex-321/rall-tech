                ...
                <div class="col-md-12">
                    <div class="card card-info" style="border: 1px solid #ccc;">
                        <div class="card-header">
                            <h3 class="card-title">Add contact data <small></small></h3>
                        </div>
                        <div class="container">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value->ogtype }}</td>
                    <td>
                        <a href="{{ url('admin/contact/edit/'.$value->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{ url('admin/contact/delete/'.$value->id) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
