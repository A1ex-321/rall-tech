...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="file" name="ogimage" class="form-control" id="exampleInputEmail1" placeholder="" value="">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="exampleInputEmail1">OG URL<span style="color:red">*</span></label>
            <input type="url" name="ogurl" class="form-control" id="exampleInputEmail1" placeholder="" value="">
        </div>
    </div>
</div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ asset('public/images/' . $value->ogimage) }}" alt="" width="100" height="60">
                    </td>
                    <td>{{ $value->ogurl }}</td>
                    <td>{{ $value->ogtype }}</td>
                    <td>
                        <a href="{{url('admin/home/edit/'.$value->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{url('admin/home/delete/'.$value->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
