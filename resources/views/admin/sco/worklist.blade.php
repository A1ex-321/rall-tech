                ...
                <div class="col-md-12">
                    <div class="card card-info" style="border: 1px solid #ccc;">
                        <div class="card-header">
                            <h3 class="card-title">Add work data <small></small></h3>
                        </div>
                        <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value->ogimage }}
                        <img src="{{ $value->ogimage }}" alt="OG Image" style="max-width: 100px; max-height: 60px;">
                    </td>
                    <td>{{ $value->ogurl }}</td>
                    <td>{{ $value->ogtype }}</td>
                    <td>
                        <a href="{{url('admin/work/edit/'.$value->id)}}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{url('admin/work/delete/'.$value->id)}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
