        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-y: auto;">
                    <form action="{{ route('resource-update', ['id' => $getRecord->id])}}" method="post" enctype="multipart/form-data" id="sco">
                        {{csrf_field()}}
                        <div class="form-row">
    <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Resource Data <small></small></h3>
                        </div>
                        <div class="container">
                            <form action="{{ route('resource-update', ['id' => $getRecord->id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
