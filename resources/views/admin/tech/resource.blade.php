...
#6e9ee6
;">
                                    <h3 class="card-title">Add Resource data <small></small></h3>
                                </div>
                                <div class="container">
                                    <form action="{{ route('create-resource') }}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                            ...
                            <table class="table table-bordered table-hover datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/resourceedit/edit/'.$value->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="{{url('admin/resource/delete/'.$value->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
