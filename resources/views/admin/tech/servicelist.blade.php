...
<div class="content-wrapper">
    ...
    <div class="float-sm-right">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="fas fa-plus"></i> Add service</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('add-service1') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                                    ...
                                    <tr>
                                        ...
                                        <a href="#" class="btn btn-info edit-btn" data-id="{{ $value->id }}" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></a>
                                            ...
                                            <a onclick="return confirm('Are you sure you want to delete?')"
                                                href="{{url('admin/addservice/delete/'.$value->id)}}" class="btn btn-danger"><i
    ...
    <form id="editForm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img id="editImagePreview" src="" alt="Image" style="height: 60px;">
        </div>
  ...
  <script>
    $(document).ready(function () {
        $('.edit-btn').on('click', function () {
            var id = $(this).data('id');
            $('#editForm').attr('action', "{{ route('updateservice', '') }}" + '/' + id);
            $.ajax({
                type: "GET",
                url: "{{ url('admin/addservice/edit') }}" + '/' + id,
