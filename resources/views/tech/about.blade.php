...
<style>
    .custom-container .team-slide-one {
        max-width: 60%;
        /* Adjust this value to set your desired slider width */
        margin: 0 auto;
        /* This centers the slider in the container */
        display: block;
    }
    ...
    .custom-container .team-slide-one div img {
        max-width: 100%;
        /* Ensures images are responsive within the slider */
        height: auto;
        /* Maintains aspect ratio */
        display: block;
        /* Centers images in their div if not already centered */
        margin: 0 auto;
...
<section class="breadcrumbs-section bg_cover" style="padding:10px;background-color:#462f2261;">
...
<section class="features-area-v4 pt-30 pb-80">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="">
                <div class="features-box mb-40 features-video bg_cover" style="">
...
<section class="team-area-v3 team-area-v4 bg_cover" style="background-image: url({{ asset('public/tech/assets/images/bg/pattern-bg-2.jpg') }}); height: 400px;">

    <div class="container">
        <div class="row justify-content-center">
            <div class="section-title section-white-title text-center mb-90">
                <h2 style="margin-top: 50px; display: inline-block;">RAALTECH SOLUTIONS in Associated with</h2>
