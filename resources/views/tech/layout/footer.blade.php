            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget about-widget mb-40">
                        ...
                        <!-- <ul class="social-link">
                                <li><a href="https://www.facebook.com/"><i class="fab fa-facebook" style="color: black;"></i></a></li>
                                <li><a href="https://api.whatsapp.com/send?phone=123456789"><i class="fab fa-whatsapp"  style="color: black;height: 300px;"></i></a></li>
                                <li><a href="https://www.youtube.com/"><i class="fab fa-youtube"  style="color: black;"></i></a></li>
                                <li><a href="https://www.linkedin.com/"><i class="fab fa-linkedin"  style="color: black;"></i></a></li>
                            </ul> -->
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="service-item text-center mb-55" style="height: 300px;">
                        <h3 class="position mb-30">Contact Detail
                        </h3>
