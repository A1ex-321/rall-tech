...
<section class="breadcrumbs-section bg_cover" style="background-image: url({{ asset('public/tech/assets/images/s1.png') }});">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title section-white-title text-center mb-100">
                    ...
                    <h5 style="color: #ebe7e7;">At Raaltech Solutions, we offer a wide array of services encompassing the full spectrum of
...
<!--====== Start About Section ======-->
<section class="about-area-v3 bg_cover pt-115 pb-120" style="background-image: url({{ asset('public/tech/assets/images/bg/about-bg-1.jpg') }}); margin-top: 100px;">
